...
https://en.wikipedia.org/wiki/Univalent_foundations [[file:../../.local/share/Trash/files/dependent_types.org][Dependent Types]] research in which math structures are built out of objects called types
